function ma57_install(varargin)
%
%   ma57_install installs ma57.
%
%   VARARGIN
%
...
if (v(1)==7 && v(2) < 11)
   warning('Old matlab version - we only test against 7.11 (2010b) or newer');
end
...
mexcompile(MEXFLAGS, '-c', [srcdir,'/ma57d.f'], '')
mexcompile(MEXFLAGS, '-c', 'hsl_matlab.F90', '')
if(nometis)
   mexcompile(MEXFLAGS, '-c', [srcdir,'/fakemetis.f'], '')
   mexcompile(MEXFLAGS, '-output ma57_factor', 'ma57_factor.f90 hsl_matlab.o ma57d.o ddeps.o fakemetis.o', LIBS)
   mexcompile(MEXFLAGS, '-output ma57_solve', 'ma57_solve.f90 hsl_matlab.o ma57d.o ddeps.o fakemetis.o', LIBS)
else
   mexcompile(MEXFLAGS, '-output ma57_factor', 'ma57_factor.f90 hsl_matlab.o ma57d.o ddeps.o', LIBS)
   mexcompile(MEXFLAGS, '-output ma57_solve', 'ma57_solve.f90 hsl_matlab.o ma57d.o ddeps.o', LIBS)
end
